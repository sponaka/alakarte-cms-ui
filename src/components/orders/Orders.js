...
const Orders = ({location}) => {
    ...
    console.log('customerNameSearch', location);
    ...
    return (
        <div className='orders-list'>
            ...
            <div className='orders-table'>
                <Table columns={columns} dataSource={ordersData} loading={loading} locale={{ emptyText: 'No orders found' }} pagination={{ pageSize: 3 }} />
            </div>
        </div>
    )
}
